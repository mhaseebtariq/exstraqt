...
n_test = 863901
n_preload = 1000000
test_trans_path = formatted_data_path + "aml-li-small_test_trans.csv"
train_trans_path = formatted_data_path + "aml-li-small_train_trans.csv"
test_labels_path = formatted_data_path + "aml-li-small_test_labels.csv"
train_labels_path = formatted_data_path + "aml-li-small_train_labels.csv"
preload_trans_path = formatted_data_path + "aml-li-small_preload_trans.csv"
